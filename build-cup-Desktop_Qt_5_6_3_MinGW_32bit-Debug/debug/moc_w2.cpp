...
QT_MOC_LITERAL(1, 3, 22), // "on_pushButton_released"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "w2\0on_pushButton_released\0"
};
...
const QMetaObject w2::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_w2.data,
      qt_meta_data_w2,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *w2::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_w2.stringdata0))
        return static_cast<void*>(const_cast< w2*>(this));
