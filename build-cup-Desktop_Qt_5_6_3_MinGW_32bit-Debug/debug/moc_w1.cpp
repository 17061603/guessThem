...
QT_MOC_LITERAL(1, 3, 30), // "on_thename_currentIndexChanged"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 4), // "arg1"
QT_MOC_LITERAL(4, 40, 22) // "on_pushButton_released"

    },
    "w1\0on_thename_currentIndexChanged\0\0"
    "arg1\0on_pushButton_released"
};
...
void w1::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        w1 *_t = static_cast<w1 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_thename_currentIndexChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
...
const QMetaObject w1::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_w1.data,
      qt_meta_data_w1,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *w1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_w1.stringdata0))
        return static_cast<void*>(const_cast< w1*>(this));
